...
if ( !function_exists( 'wpz_shortcode_stylesheet' ) AND get_option( 'framework_wpz_disable_shortcodes') != "true" ) {
...
function wpz_enqueue_shortcode_js () {
	...
	if ( is_admin() ) {} else {
		...
		wp_enqueue_script( 'wpz-shortcodes', get_template_directory_uri() . '/functions/js/shortcodes.js', array( 'jquery', 'jquery-ui-tabs' ), true );
