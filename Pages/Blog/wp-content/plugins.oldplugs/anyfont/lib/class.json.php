...
* Javascript, and can be directly /**
* Marker constant for serviceJSON::decode(), used to flag stack state
*/
...
/**
* Behavior switch for serviceJSON::decode()
*/
...
*
* <code>
* // create a new instance of serviceJSON
...
class serviceJSON
{
    ...
    *                           see argument 1 to serviceJSON() above for array-parsing behavior.
        ...
        switch (gettype($var)) {
                ...
                */
                ...
                if (is_array($var) && count($var) && (array_keys($var) !== range(0, sizeof($var) - 1))) {
                    ...
                    foreach($properties as $property)
                        if(serviceJSON::isError($property))
                            return $property;
                ...
                foreach($elements as $element)
                    if(serviceJSON::isError($element))
                        return $element;
            ...
            default:
                return ($this->use & SERVICES_JSON_SUPPRESS_ERRORS)
                    ? 'null'
                    : new serviceJSON_Error(gettype($var)." can not be encoded as JSON string");
        }
    }
    ...
    */
    function name_value($name, $value)
    {
        ...
        if(serviceJSON::isError($encoded_value))
    ...
    *                   See argument 1 to serviceJSON() above for object-output behavior.
...
if (class_exists('pear_error')) {
    ...
    class serviceJSON_Error extends PEAR_Error
    {
        function serviceJSON_Error($message = 'unknown error', $code = null,
